...
"bug:raise RuntimeErro-grad can be implicitly created only for scalar outputs"
...
# partition_seed = [25524, 4173, 11037, 64752, 46996]
partition_seed = [46996]
train_data_list = []
val_data_list = []
test_data_list = []
